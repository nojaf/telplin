...
type OptionBuilder() =
    ...
    member inline _.Combine (m : 'input option, [<InlineIfLambda>] binder : 'input -> 'output option) : 'output option =
    ...
    member inline _.BindReturn (input : 'input option, [<InlineIfLambda>] mapper : 'input -> 'output) : 'output option =
